...
int check_triggermatching(const char* datadir,const char* outfile)
{
  ...
  for(int i=0;i<mwdcnum;i++){
    histrepo1d_mwdc_global.push_back(new TH1F(TString("h")+boardinfo[i]->GetName()+TString("_TriggerMatching_Board"),boardinfo[i]->GetTitle()+TString("_TriggerMatching_Board"),3500,-45.5,3000.5));
    histrepo1d_mwdc_global[i]->SetDirectory(0);
  }
  std::vector<TH1F*> histrepo1d_mwdc_global_trailing;
  for(int i=0;i<mwdcnum;i++){
    histrepo1d_mwdc_global_trailing.push_back(new TH1F(TString("h")+boardinfo[i]->GetName()+TString("_TriggerMatching_Board_Trailing"),boardinfo[i]->GetTitle()+TString("_TriggerMatching_Board_Trailing"),3500,-45.5,3000.5));
    histrepo1d_mwdc_global_trailing[i]->SetDirectory(0);
  }
  std::vector<TH1F*> histrepo1d_mwdc_global_tot;
  for(int i=0;i<mwdcnum;i++){
    histrepo1d_mwdc_global_tot.push_back(new TH1F(TString("h")+boardinfo[i]->GetName()+TString("_TriggerMatching_Board_ToT"),boardinfo[i]->GetTitle()+TString("_TriggerMatching_Board_ToT"),500,-45.5,3000.5));
    histrepo1d_mwdc_global_tot[i]->SetDirectory(0);
  }
  std::vector<TH1F*> histrepo1d_mwdc_global_tot_highcut;
  for(int i=0;i<mwdcnum;i++){
    histrepo1d_mwdc_global_tot_highcut.push_back(new TH1F(TString("h")+boardinfo[i]->GetName()+TString("_TriggerMatching_Board_ToT_HighCut"),boardinfo[i]->GetTitle()+TString("_TriggerMatching_Board_ToT_HighCut"),500,-45.5,3000.5));
    histrepo1d_mwdc_global_tot_highcut[i]->SetDirectory(0);
  }
  std::vector<TH1F*> histrepo1d_mwdc_global_tot_lowcut;
  for(int i=0;i<mwdcnum;i++){
    histrepo1d_mwdc_global_tot_lowcut.push_back(new TH1F(TString("h")+boardinfo[i]->GetName()+TString("_TriggerMatching_Board_ToT_LowCut"),boardinfo[i]->GetTitle()+TString("_TriggerMatching_Board_ToT_LowCut"),500,-45.5,3000.5));
  ...
  for(int i=0;i<mwdcnum;i++){
    h2d_mwdc_leading_vs_trailing.push_back(new TH2F(TString("h2d_")+boardinfo[i]->GetName()+TString("_Leading_VS_Trailing"),boardinfo[i]->GetTitle()+TString("_Leading_VS_Trailing"),3500,-45.5,3000.5,3500,-45.5,3000.5));
  ...
  for(int i=0;i<tofnum;i++){
    ...
    h2d_tof_timeleading_vs_timetrailing[i]->Write(0,TObject::kOverwrite);
  }
  for(int i=0;i<tofnum;i++){
    ...
    h2d_tof_leading_vs_trailing[i]->Write(0,TObject::kOverwrite);
  }
